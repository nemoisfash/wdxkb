		...
		1: [function(require, module, exports) {
			(function(process, global) {
				...
				MqttClient.prototype.subscribe = function() {
					...
					if (Array.isArray(obj)) {
						obj.forEach(function(topic) {
							if (that._resubscribeTopics[topic] < opts.qos || !that._resubscribeTopics.hasOwnProperty(topic) ||
								resubscribe) {
								subs.push({
									topic: topic,
									qos: opts.qos
				...
				MqttClient.prototype._handleConnack = function(packet) {
					...
					var errors = ["", "Unacceptable protocol version", "Identifier rejected", "Server unavailable",
