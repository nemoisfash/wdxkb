...
app.controller('myCtrl', function($scope,$http,$interval) {
	$http({
		method: 'GET',
		url:"/admin/logging/alarm/data.json",
		cache:false,
		async:false
	}).then(function(res){
		$scope.items=res.data.warningRecords.content;
		var totalElements=res.data.warningRecords.totalElements;
		var totalPages=res.data.warningRecords.totalPages;
...
$scope.exportData=function(){
	window.location.href="/admin/logging/alarm/exportdata";
}
