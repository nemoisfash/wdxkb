...
app.controller('myCtrl', function($scope,$http,$interval) {
	$http({
		method: 'GET',
		url:"/admin/logging/manual/data.json",
		cache:false,
		async:false
	}).then(function(res){
		$scope.items=res.data.manualRecords.content;
		var totalElements=res.data.manualRecords.totalElements;
		var totalPages=res.data.manualRecords.totalPages;
...
$scope.exportData=function(){
	window.location.href="/admin/logging/manual/exportdata";
}
